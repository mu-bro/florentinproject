...
$_['text_agree']           = 'Я прочитал документ <a class="colorbox" href="%s" alt="%s"><b>%s</b></a> и согласен с условиями';
...
/* replaced "text_account_already" */ $_["text_account_already"] = "Если Вы уже зарегистрированы, перейдите на страницу <a href=\"%s\">входа в систему</a>.";
/* replaced "text_your_password" */ $_["text_your_password"] = "Ваш пароль";
/* replaced "heading_title" */ $_["heading_title"] = "Регистрация";
?>