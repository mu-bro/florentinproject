        ...
        <div class="mini-cart-info">
            <table>
                ...
                <tr>
                    ...
                    <td class="quantity">
                        <input type="text" name="quantity[<?php echo $product['key']; ?>]" id="qty_<?php echo $product['key']; ?>"
                               value="<?php echo $product['quantity']; ?>"
                               onkeyup="changeProductQty('<?php echo $product['key']; ?>',this);"/>
                    </td>
                    <td class="total"><?php echo $product['total']; ?></td>
                    <td class="remove"><img src="catalog/view/theme/florentin/image/delete.png"
...
<script>
    ...
    function changeProductQty(q_key, cur_item) {
        setTimeout(function () {
            ...
            if (p_value == 0 || isNaN(p_value) || p_value === undefined) {
                canUpdate = true;
                return false;
            }
            $.ajax({
