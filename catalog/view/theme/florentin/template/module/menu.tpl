	...
	<div class="login_block">
		<?php if (!$logged) { ?>
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<input type="text" name="email" value="" placeholder="Электронная почта" style="width: 130px;" />
					</td>
					<td>
				...
				<tr>
					<td>
						<input type="password" name="password" value="" placeholder="Пароль" style="width: 130px;" />
		...
		<?php } else { ?>
			<table cellpadding="0" cellspacing="0" class="user_logged" style="margin:10px;">
				<tr>
					...
					<td>
						<a class="button" href="<?php echo $this->url->link('account/logout', '', 'SSL'); ?>">Выйти</a>
					</td>
				</tr>			
				<tr>
					<td colspan="2">
