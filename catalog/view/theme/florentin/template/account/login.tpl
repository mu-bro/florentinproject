...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="login-content">
    <div class="left">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <div class="content">
          ...
          <br />
          <br />
          <label class="input_label"><?php echo $entry_password; ?></label>
          <input type="password"  size="30"  name="password" value="<?php echo $password; ?>" />
          <br />
          <a class="black" href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a><br />
          <br />
    ...
    <div class="right" style="min-height: 227px;">
