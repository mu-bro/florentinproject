...
$this->data = array_merge( $this->data , $this->language->load('account/forgotten'));
...
$this->data = array_merge( $this->data , $this->language->load('mail/forgotten'));
			...
			$message .= $this->language->get('text_password') . "<br/><br/>";
			$message .= $password;
