...
// 				}
			...
			$this->data['address_1'] = isset($this->request->post['address_1']) ? $this->session->data['guest']['payment']['address_1'] : "";
			$this->session->data['payment']['address_1'] = isset($this->request->post['address_1']) ? $this->session->data['guest']['payment']['address_1'] : "";
