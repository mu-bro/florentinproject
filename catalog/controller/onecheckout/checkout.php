...
// 		}
        ...
        if ($this->customer->isLogged()) {
            ...
            if (isset($this->session->data['shipping_address_id']) && (int)$this->session->data['shipping_address_id'] && !is_null($this->session->data['shipping_address_id'])
            ) {
        ...
        if (isset($shipping_address)) {
            ...
            $this->data['shipping_postcode'] = isset($shipping_address['postcode']) ? $shipping_address['postcode'] : '';
