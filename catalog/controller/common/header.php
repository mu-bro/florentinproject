...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data = array_merge( $this->data , $this->language->load('common/header'));


		$this->data['text_shopping_cart'] = sprintf($this->language->get('text_shopping_cart'), $this->cart->countProducts());
		...
		$this->data['menu'] = $this->getChild('module/menu', $menu_setting);
