...
class ModelAccountCustomer extends Model {
	...
	public function editNewsletter($newsletter) {
		...
		if (!$newsletter) {
			$email = $this->db->query("SELECT email FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$this->customer->getId() . "'")->row["email"];
			$emailCount = $this->db->query("DELETE FROM " . DB_PREFIX . "subscribers WHERE email = '" . $email . "'");
		}
