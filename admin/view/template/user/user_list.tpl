        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left">
					<?php if (isset($store_sities[$user['store_id']])) echo $store_sities[$user['store_id']]['config_name'] . " (" . $store_sities[$user['store_id']]['country'] ." - " .$store_sities[$user['store_id']]['zone'] . ")"; ?>
			</td>
