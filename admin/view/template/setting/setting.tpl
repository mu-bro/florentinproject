      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> Персональный телефон:</td>
              <td><input type="text" name="config_per_telephone" value="<?php echo $config_per_telephone; ?>" size="40"/>
                <?php if ($error_per_telephone) { ?>
                <span class="error"><?php echo $error_per_telephone; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> Персональный емейл:</td>
              <td><input type="text" name="config_per_email" value="<?php echo $config_per_email; ?>" size="40"/>
                <?php if ($error_per_email) { ?>
                <span class="error"><?php echo $error_per_email; ?></span>
                <?php } ?></td>
            </tr>            
            <tr>
              <td><span class="required">*</span> Корпоративный телефон:</td>
              <td><input type="text" name="config_cor_telephone" value="<?php echo $config_cor_telephone; ?>" size="40"/>
                <?php if ($error_cor_telephone) { ?>
                <span class="error"><?php echo $error_cor_telephone; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> Корпоративный емейл:</td>
              <td><input type="text" name="config_cor_email" value="<?php echo $config_cor_email; ?>" size="40"/>
                <?php if ($error_cor_email) { ?>
                <span class="error"><?php echo $error_cor_email; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> Текст акции:</td>
              <td><textarea name="config_promo_text" cols="40" rows="5"><?php echo $config_promo_text; ?></textarea></td>
            </tr>               
            <tr>
        ...
        <div id="tab-option">
          ...
          <h2>Купон и бонусные балы</h2>
          <table class="form">
            <tr>
              <td>Разрешить купоны:</td>
				<td>
					<?php if ($config_coupon_status) { ?>
						<input type="radio" name="config_coupon_status" value="1" checked="checked" />
						<?php echo $text_yes; ?>
						<input type="radio" name="config_coupon_status" value="0" />
						<?php echo $text_no; ?>
					<?php } else { ?>
						<input type="radio" name="config_coupon_status" value="1" />
						<?php echo $text_yes; ?>
						<input type="radio" name="config_coupon_status" value="0" checked="checked" />
						<?php echo $text_no; ?>
					<?php } ?>
                </td>
            </tr>
            <tr>
              <td>Разрешить бонусные баллы:</td>
				<td>
					<?php if ($config_reward_points) { ?>
						<input type="radio" name="config_reward_points" value="1" checked="checked" />
						<?php echo $text_yes; ?>
						<input type="radio" name="config_reward_points" value="0" />
						<?php echo $text_no; ?>
					<?php } else { ?>
						<input type="radio" name="config_reward_points" value="1" />
						<?php echo $text_yes; ?>
						<input type="radio" name="config_reward_points" value="0" checked="checked" />
						<?php echo $text_no; ?>
					<?php } ?>
                </td>
            </tr>
          ...
          <table class="form">
            <tr>
              ...
              <td>
				<select name="config_start_interval">
                  <?php foreach($possibleTime as $k => $time) { ?>
						<?php if ($time == $config_start_interval) { ?>
                ...
                -
				<select name="config_end_interval">
                  <?php foreach($possibleTime as $k => $time) { ?>
						<?php if ($time == $config_end_interval) { ?>
							<option value="<?php echo $time; ?>" selected="selected"><?php echo $time; ?></option>
						<?php } else { ?>
							<option value="<?php echo $time; ?>"><?php echo $time; ?></option>
						<?php } ?>
            ...
            <tr>
              <td>Интервал минут:</td>
              <td><select name="config_minute_interval">
                  <?php for ($i=1;$i<=240;$i++) { ?>
						<?php if ($i == $config_minute_interval) { ?>
            ...
            <tr>
				<td>Доставка через день после:</td>
				<td><select name="config_next_day_time">
					<?php for ($i=0;$i<=23;$i++) { ?>
						<?php if ($i == $config_next_day_time) { ?>
