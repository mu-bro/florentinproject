          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea rows="4" style="width:100%" maxlength="300" name="product_description[<?php echo $language['language_id']; ?>][short_descr]"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_descr'] : ''; ?></textarea></td>
              </tr>              
              <tr>
        ...
        <div id="tab-data">
          <table class="form">        
            ...
            <tr>
              ...
              <td><input type="radio" name="shipping" value="1" checked="checked" /></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Пометить как новый:</td>
              <td><input type="checkbox" name="isNew" value="1" <?php if ($isNew) echo 'checked="checked"'; ?> /></td>
            </tr>
            <tr>
              <td>Заказ только за 2 дня:</td>
              <td><input type="checkbox" name="isTwoDaysDelivery" value="1" <?php if ($isTwoDaysDelivery) echo 'checked="checked"'; ?> /></td>
            </tr>
            <tr>
              <td>Разместить в спец.предложении:</td>
              <td><input type="checkbox" name="isSpec" value="1" <?php if ($isSpec) echo 'checked="checked"'; ?> /></td>
            </tr>             
            <tr>
