...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="" method="post" enctype="multstore_idart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
          ...
          <tbody>
				...
				<td>
					<select name="filter_store_id" >
						...
						<?php foreach($stores as $store_id => $store) { ?>
							<option value="<?php echo $store_id; ?>" <?php if (!is_null($filter_store_id) && $store_id == $filter_store_id) echo 'selected="selected"'; ?> >
            ...
            <tr>
              ...
              <td class="left"><?php echo $customer['approved']; ?></td>
				<?php if (!$this->user->isManager()) { ?>
					<td class="left">
						<?php echo $stores[$customer['store_id']]['config_name']; ?> - <?php echo $stores[$customer['store_id']]['zone']; ?>
					</td>
				<?php } ?>              
              ...
              <td class="left"><select onchange="((this.value !== '') ? window.open('index.php?route=sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=' + this.value) : null); this.value = '';">
                  ...
                  <?php foreach ($short_stores as $store) { ?>
