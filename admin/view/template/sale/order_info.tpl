...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
      <a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div class="vtabs">
      <a href="#tab-order"><?php echo $tab_order; ?></a>
      <a href="#tab-payment"><?php echo $tab_payment; ?></a>
        <?php if ($shipping_method && $shipping_type == 0) { ?>
        <a href="#tab-shipping">Получатель</a>
        <?php } ?>
...
<!--          <tr>
          ...
          <?php } ?>          
          <tr>
            <td>Кому доставить букет?</td>
            <td><?php echo $shipping_type_text; ?></td>
          </tr>
...
<!--          <?php if ($shipping_zone_code) { ?>
          ...
          <tr>
            <td>Звонить получателю перед доставкой?</td>
            <td><?php echo $need2call_text; ?></td>
          </tr>
           <?php if ($need2call == 1) { ?>
          <tr>
            <td>Телефон:</td>
