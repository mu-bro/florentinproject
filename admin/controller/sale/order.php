...
// 			}
		...
		$this->data['sort_store_id'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&sort=o.store_id' . $url, 'SSL');
...
$this->data = array_merge( $this->data , $this->language->load('sale/order'));
			...
			$this->data['send_message'] = $order_info['send_message'];
			...
			$this->data['shipping_type_text'] = ($order_info['shipping_type'] == 1) ? "Покупателю" : "Другому получателю";
