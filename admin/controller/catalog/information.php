...
$this->data = array_merge( $this->data , $this->language->load('catalog/information'));
...
$this->data = array_merge( $this->data , $this->language->load('catalog/information'));
	...
	protected function getForm() {
		...
		$this->data['user_stores'] = $this->user->getStores();
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['information_description'] as $store_id => $info) {
			foreach ($info as $language_id => $value) {
				...
				if (!isset($value['need_left_description']))
					$value['need_left_description'] = 0;
			}
		}
