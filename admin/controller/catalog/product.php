...
$this->data = array_merge( $this->data , $this->language->load('catalog/product'));
	...
	public function filter() {
    	...
    	$this->data['stores'] = $this->user->getStores();
		...
		$this->template = 'catalog/product_list_template.tpl';

		$json['result'] = $this->render();
...
$this->data = array_merge( $this->data , $this->language->load('catalog/product'));
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['product_store'])) {
			...
			$this->data['product_store'] = $this->user->isManager() ? array($this->session->data['user_store_id']) : array(0);
		}	
		...
		if (isset($this->request->post['isNew'])) {
      		...
      		$this->data['isNew'] = $product_info['isNew'];
    	} else {
			$this->data['isNew'] = 0;
		}

		if (isset($this->request->post['isSpec'])) {
      		$this->data['isSpec'] = $this->request->post['isSpec'];
    	} elseif (!empty($product_info)) {
      		$this->data['isSpec'] = $product_info['isSpec'];
    	} else {
			$this->data['isSpec'] = 0;
		}		

		if (isset($this->request->post['isTwoDaysDelivery'])) {
      		$this->data['isTwoDaysDelivery'] = $this->request->post['isTwoDaysDelivery'];
    	} elseif (!empty($product_info)) {
      		$this->data['isTwoDaysDelivery'] = $product_info['isTwoDaysDelivery'];
    	} else {
			$this->data['isTwoDaysDelivery'] = 0;
		}		
  	...
  	protected function validateForm() { 
		...
		$this->request->post['isNew'] = (isset($this->request->post['isNew'])) ? $this->request->post['isNew'] : 0;
		$this->request->post['isTwoDaysDelivery'] = (isset($this->request->post['isTwoDaysDelivery'])) ? $this->request->post['isTwoDaysDelivery'] : 0;
		$this->request->post['isSpec'] = (isset($this->request->post['isSpec'])) ? $this->request->post['isSpec'] : 0;
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_store_id']) || isset($this->request->get['filter_category_id'])) {
			$this->load->model('catalog/product');
			$this->load->model('catalog/option');
