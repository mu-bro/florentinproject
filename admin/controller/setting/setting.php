...
$this->data = array_merge( $this->data , $this->language->load('setting/setting')); 
		...
		$this->data['possibleTime'] = $this->document->getPossibleTime();
		...
		if (isset($this->error['per_telephone'])) {
			$this->data['error_per_telephone'] = $this->error['per_telephone'];
		} else {
			$this->data['error_per_telephone'] = '';
		}

		if (isset($this->error['cor_telephone'])) {
			$this->data['error_cor_telephone'] = $this->error['cor_telephone'];
		} else {
			$this->data['error_cor_telephone'] = '';
		}
		if (isset($this->error['per_email'])) {
			$this->data['error_per_email'] = $this->error['per_email'];
		} else {
			$this->data['error_per_email'] = '';
		}
		if (isset($this->error['cor_email'])) {
			$this->data['error_cor_email'] = $this->error['cor_email'];
		} else {
			$this->data['error_cor_email'] = '';
		}
		...
		if (isset($this->request->post['config_per_telephone'])) {
			$this->data['config_per_telephone'] = $this->request->post['config_per_telephone'];
		} else {
			$this->data['config_per_telephone'] = $this->config->get('config_per_telephone');
		}

		if (isset($this->request->post['config_cor_telephone'])) {
			$this->data['config_cor_telephone'] = $this->request->post['config_cor_telephone'];
		} else {
			$this->data['config_cor_telephone'] = $this->config->get('config_cor_telephone');
		}

		if (isset($this->request->post['config_cor_email'])) {
			$this->data['config_cor_email'] = $this->request->post['config_cor_email'];
		} else {
			$this->data['config_cor_email'] = $this->config->get('config_cor_email');
		}

		if (isset($this->request->post['config_per_email'])) {
			$this->data['config_per_email'] = $this->request->post['config_per_email'];
		} else {
			$this->data['config_per_email'] = $this->config->get('config_per_email');
		}

		if (isset($this->request->post['config_promo_text'])) {
			$this->data['config_promo_text'] = $this->request->post['config_promo_text'];
		} else {
			$this->data['config_promo_text'] = $this->config->get('config_promo_text');
		}		


		if (isset($this->request->post['config_coupon_status'])) {
			$this->data['config_coupon_status'] = $this->request->post['config_coupon_status'];
		} else {
			$this->data['config_coupon_status'] = $this->config->get('config_coupon_status');
		}


		if (isset($this->request->post['config_reward_points'])) {
			$this->data['config_reward_points'] = $this->request->post['config_reward_points'];
		} else {
			$this->data['config_reward_points'] = $this->config->get('config_reward_points');
		}
		...
		if (isset($this->request->post['config_start_interval'])) {
			$this->data['config_start_interval'] = $this->request->post['config_start_interval'];
		} else {
			$this->data['config_start_interval'] = $this->config->get('config_start_interval');
		}	

		if (isset($this->request->post['config_end_interval'])) {
			$this->data['config_end_interval'] = $this->request->post['config_end_interval'];
		} else {
			$this->data['config_end_interval'] = $this->config->get('config_end_interval');
		}

		if (isset($this->request->post['config_minute_interval'])) {
			$this->data['config_minute_interval'] = $this->request->post['config_minute_interval'];
		} else {
			$this->data['config_minute_interval'] = $this->config->get('config_minute_interval');
		}

		if (isset($this->request->post['config_next_day_time'])) {
			$this->data['config_next_day_time'] = $this->request->post['config_next_day_time'];
		} else {
			$this->data['config_next_day_time'] = $this->config->get('config_next_day_time');
		}		
