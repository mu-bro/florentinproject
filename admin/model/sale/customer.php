...
class ModelSaleCustomer extends Model {
	...
	public function getCustomers($data = array()) {
		...
		if ($this->session->data['user_group_id'] == 11) {
			$sql .= " AND c.store_id = '" . (int)$this->session->data['user_store_id'] . "'";
	...
	public function getTotalCustomers($data = array()) {
		...
		if ($this->session->data['user_group_id'] == 11) {
			$implode[] = " store_id = '" . (int)$this->session->data['user_store_id'] . "'";
	...
	public function addReward($customer_id, $description = '', $points = '', $order_id = 0) {
		...
		if ($customer_info) { 
			...
			$message  = sprintf($this->language->get('text_reward_received'), $points) . "<br/><br/>";
